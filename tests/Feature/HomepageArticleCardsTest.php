            ...
            $article =
                Article::create([
                    ...
                    'slug' =>
                        ...
                        . $index,
                    'excerpt' =>
                        'Krótki wstęp publikacji numer '
                        . $index
                        . '.',
                    'body_html' =>
                        '<p>Treść publikacji.</p>',
                    'status' =>
        ...
        $article =
            Article::create([
                ...
                'title' =>
                    'Test poziomej karty',
                'slug' =>
                    'legacy-test-poziomej-karty',
                'excerpt' =>
                    'To jest krótki wstęp wyświetlany obok pionowej miniatury.',
                'body_html' =>
                    '<p>Dłuższa treść artykułu.</p>',
                'status' =>
                    ArticleStatus::Published,
                'published_at' =>
                    now(),
