...
return [
    ...
    'users' => [
        ...
        'projects' => [
            'title' => 'Projekty użytkownika',
            'kicker' => 'Moje projekty',
            'back' => 'Wróć do listy użytkowników',
            'results' => '{0} Brak projektów|{1} 1 projekt|[2,4] :count projekty|[5,*] :count projektów',
        ...
        'project_files' => [
            ...
            'back' => 'Wróć do projektów użytkownika',
            'description' => 'Pliki źródłowe, podglądy i finalne materiały projektu.',
            'kind' => 'Rodzaj',
            'file' => 'Plik',
            'type' => 'Typ',
            'size' => 'Rozmiar',
